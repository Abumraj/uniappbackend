...
class FacultyController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('director.faculty.index', compact('faculties'));
    }
    ...
    public function getForm($faculty_id='', Request $request)
    {
        ...
        return view('director.faculty.form', compact('faculty'));
    }
    ...
    public function saveFaculty(Request $request)
    {
        ...
        return $this->return_output('flash', 'success', $success_message, '/director/faculty', '200');
    }
