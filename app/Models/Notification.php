...
class Notification extends Model
{
 const API_ACCESS_KEY = '';
   ...
   static public function pushNotification($topic, $title, $body, $link=null)
    {
		...
		//$dataContent=[];
		if(isset($link)){
			$dataContent = array_merge($dataContent,['link' => "$link"]);
		...
		*/
		...
		$headers			=	array(
									'Authorization: key=' .Notification::API_ACCESS_KEY,
